	...
	public partial class MainForm : Form
	{
		...
		private void timer1_Tick(object sender, EventArgs e)
		{
			...
			if (Alarm != null && Alarm.AlarmTime.Equals(currentTime))
			{
				...
				axWindowsMediaPlayer.Ctlcontrols.play();
				int curAlarm = alarmDialog.CheckedListBoxPendingAlarms.CheckedItems.IndexOf(Alarm);
				alarmDialog.CheckedListBoxPendingAlarms.SetItemCheckState(curAlarm, CheckState.Unchecked);
